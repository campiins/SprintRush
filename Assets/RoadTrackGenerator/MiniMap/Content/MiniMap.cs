...
public class MiniMap : MonoBehaviour
{
    ...
    [Space(10)]
    public List<Transform> opponents;   // Put the white circle on the other players(AI)
    [Space(20)]
    ...
    {
        player1 = raceManager.playerController.gameObject.transform;
    }

    void OnAISpawned(GameObject opponent)
    {
        Transform opponentTransform = opponent.transform;
        if (!opponents.Contains(opponentTransform))
        {
            opponents.Add(opponentTransform);
        }
    }
    ...
    private void DefinePlayerOponents()
    {
        ...
        miniMapSpriteOpponents = new GameObject[opponents.Count];
